...
export const isSnackBuyable=(credits: number, snackToCheck:Snack) : boolean => {
    ...
    return Snacks.map((snack) => isSnackBuyable(credits - snackToCheck.price, snack)).some((value) => value)
}
